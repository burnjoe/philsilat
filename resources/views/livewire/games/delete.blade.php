<div>
   <div class="text-dark p-3">
      <h3 class=" fw-bold">DELETE GAME</h3>
      <hr class="mb-0">
   </div>
      ...
      <div class="container-fluid text-dark py-3">
         <div class="p-4"
            ...
            <div class="d-flex align-items-center">
               ...
               <span class="fs-4 ms-4">Are you sure to delete this game?</span>
            </div>

            <form wire:submit.prevent="destroy">
               <div class="form-group d-flex justify-content-end pt-4">
                  <a wire:navigate href="{{ route('games.settings', ['event' => $event->id, 'game' => $game->id]) }}" class="custBtn custBtn-light">Cancel</a>
