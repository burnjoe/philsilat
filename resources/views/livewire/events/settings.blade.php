               ...
               <div class="row row-cols-1 row-cols-lg-3 g-4 pt-3">
                  ...
                  <div class="form-group col">
                     ...
                     <input wire:model="starts_at" id="starts_at"
                        class="form-control custInput @error('starts_at') is-invalid @enderror" type="datetime-local"
                        name="starts_at" autocomplete="off" placeholder="Starts At" required style="cursor: text;">
                     @error('starts_at')
                        <span class="invalid-feedback" role="alert">
                           <strong>{{ $message }}</strong>
                        </span>
