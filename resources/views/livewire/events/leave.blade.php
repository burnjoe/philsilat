<div>
    <div class="text-dark p-3">
        <h3 class=" fw-bold">LEAVE EVENT</h3>
        <hr class="mb-0">
    </div>
        ...
        <div class="container-fluid text-dark py-3">
            <div class="p-4"
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span class="fs-4 ms-4">Are you sure to drop your team including its athlete from the event?</span>
                </div>

                <form wire:submit.prevent="leave">
                    <div class="form-group d-flex justify-content-end pt-4">
                        ...
                        <button type="submit" value="true" class="custBtn custBtn-red ms-3">Leave Event</button>
                    </div>
                </form>
            </div>
        </div>
