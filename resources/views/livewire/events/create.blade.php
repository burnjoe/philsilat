        ...
        <div class="p-4"
            ...
            <form wire:submit.prevent="store">
                <div class="row row-cols-1 row-cols-sm-2 g-4">
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="host_name" id="host_name"
                            ...
                            name="host_name" autocomplete="off" placeholder="e.g., Juan Dela Cruz" required autofocus>
                        @error('host_name')
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="name" id="name"
                            class="form-control custInput @error('name') is-invalid @enderror" type="text" name="name"
                            autocomplete="off" placeholder="Event Name" required>
                        @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 pt-3">
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="venue" id="venue"
                            class="form-control custInput @error('venue') is-invalid @enderror" type="text" name="venue"
                            autocomplete="off" placeholder="Venue" required>
                        @error('venue')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="starts_at" id="starts_at"
                            ...
                            type="datetime-local" name="starts_at" autocomplete="off" placeholder="Starts At" required
                            style="cursor: text;">
                        @error('starts_at')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="ends_at" id="ends_at"
                            class="form-control custInput @error('ends_at') is-invalid @enderror" type="datetime-local"
                            name="ends_at" autocomplete="off" placeholder="Ends At" required style="cursor: text;">
                        @error('ends_at')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 pt-3">
                    ...
                    <div class="form-group col">
                        ...
                        <input wire:model="city" id="city"
                            class="form-control custInput @error('city') is-invalid @enderror" type="text" name="city"
                            autocomplete="off" placeholder="City / Municipality" required>
                        @error('city')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group d-flex justify-content-end pt-4">
                    <a href="{{ route('events') }}" class="custBtn custBtn-light">Cancel</a>
