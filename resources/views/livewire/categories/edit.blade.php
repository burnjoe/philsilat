            ...
            <div class="p-4"
                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="row row-cols-1 row-cols-lg-2 g-4 pt-3">
                        <div class="form-group col">
                            ...
                            <input wire:model="min_weight" id="min_weight"
                                ...
                                step="0.01" name="min_weight" maxlength="50" autocomplete="off"
                        ...
                        <div class="form-group col">
                            ...
                            <input wire:model="max_weight" id="max_weight"
                                ...
                                step="0.01" name="max_weight" maxlength="50" autocomplete="off"
                                placeholder="Maximum Weight" required>
                            @error('max_weight')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group d-flex justify-content-end pt-4">
                        <a wire:navigate href="{{ route('categories') }}" wire:navigate class="custBtn custBtn-light">Cancel</a>
