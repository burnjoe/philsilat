                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-4">
                        <div class="form-group col">
                            <label for="current_password">Current Password<span style="color: #b63e3e;">
                                    *</span></label>
                            <input id="current_password" type="password"
                                class="form-control custInput @error('current_password') is-invalid @enderror"
                                wire:model="current_password" placeholder="Current Password" autofocus>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-4 mt-1">
                        <div class="form-group col">
                            ...
                            <input id="password" type="password"
                                ...
                                wire:model="password" placeholder="New Password" autofocus>
                            @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 g-4 mt-1">
                        <div class="form-group col">
                            ...
                            <input id="password-confirm" type="password"
                                ...
                                wire:model="password_confirmation" placeholder="Confirm Password" autofocus>
